...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function () {
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    const buttons = []; // btns = {count: num, settings: [[text, classNames={}, close, cb]]}
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.eq = function (i) {
  const swap = this[i];
  const oblLength = Object.keys(this).length;

  for (let i = 0; i < oblLength; i++) {
    delete this[i];
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  ...
  for (; numberOfItems < oblLength; numberOfItems++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get("https://jsonplaceholder.typicode.com/todos/20").then(res => console.log(res));
